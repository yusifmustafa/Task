import {
    Button, Modal, styled, Table, TableBody, TableCell, TableHead, TableRow,
} from "@mui/material";
...
const DataList = () => {
    ...
    const currentEmployees = userList.slice(indexOfFirstEmployee, indexOfLastEmployee);
    const notifyDelete = () => {
  ...
  `;
    return (<div>
        ...
        <StyledTable>
            ...
            <TableBody>
                {currentEmployees.map((user) => (<TRow key={user.id}>
